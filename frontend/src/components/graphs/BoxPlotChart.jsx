...
// num_gt1_cat_0_temp_0 --  mockData5(3num)
// num_gt1_cat_0_temp_0 --  mockData6(4num)
// num_1_cat_1_temp_0_outliers --  mockData7
// num_1_cat_1_temp_0_ordered --  mockData8


const type = "num_1_cat_1_temp_0_ordered"; 
const mockData = mockData8;
      ...
      data: cat2s.map(subcat =>
        ({
          ...
          x: cat1s.flatMap(cat1 =>
            Array(
              mockData.filter(item => item[cat1Key] === cat1 && item[cat2Key] === subcat).length
            ).fill(cat1)
          ),
          name: subcat,
          type: "box",
