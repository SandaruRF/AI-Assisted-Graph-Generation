...
app.include_router(query_router, prefix="/agents/sql_agent", tags=["NL to SQL Query"])
#app.include_router(metadata_router)
app.include_router(get_database_router, prefix="/agents/sql_agent", tags=["Database Connector"])
